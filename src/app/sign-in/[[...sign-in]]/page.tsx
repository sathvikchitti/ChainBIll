  ...
  return (
    <main className="min-h-screen bg-background flex flex-col items-center justify-center gap-8 px-6">
      <div className="text-center">
        <h1 className="text-primary tracking-tight flex items-center justify-center gap-3" style={{ fontFamily: "'Playfair Display', serif", fontSize: '32px', fontWeight: 700 }}><img src="/chainbill-logo.png" alt="ChainBill" className="h-10 w-10 object-contain" />ChainBill</h1>
